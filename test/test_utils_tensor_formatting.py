...
class TestFormatPreds(unittest.TestCase):
    def setUp(self):
        ...
        self.single_prediction[4, 0, 0] = 1.
        # one-hot class pred
        self.single_prediction[5, :, :] = 1.
        ...
        self.single_prediction_with_cxcywh_box[5, :, :] = 1.  # one-hot class pred
        self.single_prediction_with_cxcywh_box[4, 1, 1] = 1.
    ...
    def test_no_predictions(self):
        ...
        """
        torch.testing.assert_close(format_preds(self.no_predictions), torch.empty(0,12))
    ...
    def test_single_prediction_with_cxcywh_box(self):
        ...
        torch.testing.assert_close(pred, self.single_prediction_with_cxcywh_box[:, 1, 1].unsqueeze(0))
